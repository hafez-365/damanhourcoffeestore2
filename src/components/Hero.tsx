    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-900 via-orange-800 to-red-900 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 right-20 animate-pulse">
          <Coffee size={80} className="text-amber-300" />
        </div>
        <div className="absolute bottom-32 left-20 animate-bounce">
          <Coffee size={60} className="text-orange-300" />
        </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-6xl md:text-8xl font-bold text-amber-100 mb-6 drop-shadow-2xl">
            قهوة دمنهور
          </h1>
          ...
          <p className="text-xl md:text-2xl text-amber-200 mb-12 leading-relaxed">
            أجود أنواع القهوة العربية الأصيلة من قلب دمنهور
            <br />
            طعم لا يُنسى وجودة لا تُضاهى
          </p>
